(ns emojillionaire.components.code-page
  (:require
    ...
    [emojillionaire.components.highlight :refer [highlight]]
        ...
        (fn []
          (let [code (:code @contract)]
            [outer-paper
             ...
             [:p [u/new-window-link @contract-etherscan-url "Open smart contract in Etherscan"] [:br]
              [u/new-window-link "https://github.com/madvas/emojillionaire/blob/master/resources/public/contracts/src/emojillionaire.sol"
               "Open smart contract on Github"]]
